...
>
	<div
		class="p-4 lg:px-[44px] bg-white h-full lg:h-auto w-full lg:max-w-md mx-auto lg:rounded-2xl shadow-xl z-50 overflow-y-auto"
	>
		...
		{#if !invalidPhone}
			<form action="?/checkOtp" use:enhance method="POST" class="pb-10">
				<div class="my-5">
					<TextField
						label="Code"
						placeholder="Code"
